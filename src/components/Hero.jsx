                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-16 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-12 max-w-3xl mx-auto z-10 relative pointer-events-auto">
                            {[
                                { text: 'MERN Stack', color: 'from-cyan-400 to-blue-500', shadow: 'rgba(6,182,212,0.4)', textGlow: 'text-cyan-400' },
                                { text: 'React.js', color: 'from-teal-400 to-emerald-500', shadow: 'rgba(45,212,191,0.4)', textGlow: 'text-teal-400' },
                                { text: 'Node.js', color: 'from-blue-400 to-indigo-500', shadow: 'rgba(59,130,246,0.4)', textGlow: 'text-blue-400' }
                            ].map((badge, index) => (
                                <motion.div
                                    key={badge.text}
