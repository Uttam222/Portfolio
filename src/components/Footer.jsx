...
const Footer = () => {
    ...
    const SOCIALS = [
        { icon: Linkedin, href: 'https://www.linkedin.com/in/uttam1-kumar/', color: 'hover:text-[#0ea5e9]', glow: 'hover:shadow-[0_0_20px_#0ea5e9]' },
        { icon: Github, href: 'https://github.com/Uttam222', color: 'hover:text-white', glow: 'hover:shadow-[0_0_20px_rgba(255,255,255,0.5)]' },
        { icon: Mail, href: 'mailto:me.uttam222@gmail.com', color: 'hover:text-[#22c55e]', glow: 'hover:shadow-[0_0_20px_#22c55e]' }
    ];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-black font-orbitron tracking-tighter relative z-10">
                        <span className="text-slate-800 dark:text-white">Uttam</span>
                ...
                >
                    <span>© {new Date().getFullYear()} Uttam Kumar.</span>
