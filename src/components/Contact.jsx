...
const CONTACT_ITEMS = [
    { label: 'Email', value: 'me.uttam222@gmail.com', href: 'mailto:me.uttam222@gmail.com', icon: Mail, color: 'text-sky-500', glow: 'rgba(14,165,233,0.6)' },
    { label: 'Phone', value: '+91 9708004242', href: 'tel:+919708004242', icon: Phone, color: 'text-sky-400', glow: 'rgba(56,189,248,0.6)' },
    { label: 'LinkedIn', value: 'in/uttam1-kumar', href: 'https://www.linkedin.com/in/uttam1-kumar/', icon: Linkedin, color: 'text-green-500', external: true, glow: 'rgba(34,197,94,0.6)' },
    { label: 'GitHub', value: 'github.com/Uttam222', href: 'https://github.com/Uttam222', icon: Github, color: 'text-slate-500', external: true, glow: 'rgba(148,163,184,0.6)' },
];
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                >
                    <CyberCard glowColor="rgba(14,165,233,0.5)" colorFrom="#0ea5e9" className="w-full group">
                        ...
                        <form action="https://formsubmit.co/me.uttam222@gmail.com" method="POST" className="space-y-6" onSubmit={handleSubmit}>
